...
> One place to understand how the Queue Management app works end-to-end — for you, future agents, and anyone joining the project.
...
5. Dashboard header shows an **outlet switcher** and three tabs: **Live queue · Analytics · Settings**.
6. Use the header to add more outlets (Outlets page), switch between them, or go to Analytics / Settings for the selected outlet.
...
When unsure whether a change belongs here, ask: _"Would a new developer or the user themself need to know this to understand the app?"_ If yes, update.
with JWT auth.
