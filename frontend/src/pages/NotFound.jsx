  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background px-5">
      <div className="text-center">
        <p className="text-[11px] uppercase tracking-[0.26em] text-primary">404</p>
        ...
        <Link to="/" className="inline-block mt-8" data-testid="not-found-home">
          <Button className="rounded-full bg-foreground hover:bg-foreground/90 text-white h-11 px-6">Back to home</Button>
        </Link>
      </div>
    </div>
  );
