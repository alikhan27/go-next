            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-3 text-stone-600 text-sm">
                    Use this only if you didn&apos;t reset your own password.
                    We&apos;ll immediately block sign-in and invalidate any
                    outstanding reset links. You can regain access by contacting
                    our team.
                  </p>
                </div>
              </div>
              ...
              {!token && (
                <p className="mt-3 text-xs text-red-600 text-center">
                  Missing token. Please use the link we sent.
                </p>
              )}
            </div>
          ) : (
            <div
              className="mt-5 rounded-2xl border border-stone-200 bg-white p-6 text-center"
              data-testid="lock-success-card"
            >
              <ShieldCheck className="h-10 w-10 text-red-600 mx-auto" />
              <h1 className="font-serif-display text-3xl mt-3">
                Account frozen
              </h1>
              <p className="mt-2 text-sm text-stone-600">
                Sign-in is blocked for <strong>{done.email}</strong>. Contact
                our team to restore access.
              </p>
              <Button
                onClick={() => navigate("/")}
