    ...
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="relative mx-auto max-w-6xl px-5 pt-14 pb-20 lg:pt-24 lg:pb-28">
          <div className="grid gap-10 lg:grid-cols-12 lg:gap-12">
            <div className="lg:col-span-7">
              <p
                className="text-[11px] uppercase tracking-[0.26em] text-primary"
              ...
              <h1 className="font-serif-display mt-4 text-4xl sm:text-5xl lg:text-6xl leading-[1.05] tracking-tight">
                ...
                <span className="italic text-primary">
                  to keep every chair busy.
                </span>
              </h1>
              <p className="mt-6 max-w-xl text-base sm:text-lg leading-relaxed text-stone-600">
                Built for real service floors: morning rush, weekend peaks, and
                the in-between walk-ins. Owners get a grounded dashboard. Guests
                get transparent wait times.
              </p>
              ...
              <div className="mt-8 flex flex-wrap gap-3 stagger-in">
                ...
                <Link to="/join/demo-salon" data-testid="hero-cta-demo">
                  <Button
                    variant="outline"
                    className="rounded-full h-12 px-7 border-stone-300 hover:bg-white/70 press"
                  >
        ...
        <div className="mt-14 grid gap-6 md:grid-cols-3 stagger-in">
          {features.map((f) => (
            ...
            >
              ...
              <h3 className="font-serif-display mt-5 text-2xl leading-tight">
                {f.title}
              </h3>
              ...
              {[
                {
                  ...
                  b: "Sign up once. Name, address, number of stations — done.",
                },
                {
                  t: "Print your QR",
                  b: "Guests scan it, enter a name, and join the live queue.",
                },
                {
                  t: "Call next, tap done",
                  b: "Your dashboard moves tokens between Waiting and Serving.",
                },
                {
                  t: "Everyone keeps rhythm",
                  b: "Stations stay full. Guests stay informed. No double bookings.",
                },
              ].map((s, i) => (
      ...
      <section id="pricing" className="bg-white border-t border-stone-200">
        <div className="mx-auto max-w-6xl px-5 py-20 lg:py-28">
          <div className="max-w-3xl">
            ...
            <h2 className="font-serif-display mt-3 text-3xl sm:text-4xl lg:text-5xl leading-tight">
              Start free.{" "}
              <span className="italic">Grow when you&apos;re ready.</span>
            </h2>
            <p className="mt-4 text-stone-600 text-base sm:text-lg max-w-xl">
              Three plans. Transparent limits. Move up when you open a second
              outlet, want custom services with accurate ETAs, or run a full
              chain.
            </p>
          </div>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3 stagger-in">
            {/* Free */}
            <div
              className="rounded-3xl border border-stone-200 bg-background p-8"
            ...
            >
              <div className="flex items-baseline justify-between">
                ...
                <span className="rounded-full bg-stone-200 px-3 py-1 text-[10px] uppercase tracking-[0.22em] text-stone-600">
                  for new salons
                </span>
              </div>
              ...
              >
                <Button
                  variant="outline"
                  className="w-full rounded-full border-stone-300 h-11 press"
                >
                  Start free
                </Button>
              </Link>
            ...
            {/* Premium */}
            <div
              className="rounded-3xl border-2 border-primary/60 bg-white p-8 shadow-sm relative overflow-hidden"
            ...
            >
              <div
                ...
                style={{
                  background:
                    "radial-gradient(400px 200px at 90% -10%, rgba(196,124,92,0.18), transparent 60%)",
                }}
              />
              <div className="relative">
                <div className="flex items-baseline justify-between">
                  ...
                  <span className="rounded-full bg-primary text-white px-3 py-1 text-[10px] uppercase tracking-[0.22em]">
                    Most popular
                  </span>
                </div>
                <p className="font-serif-display text-5xl mt-4">
                  ₹{premiumPlan?.price_monthly ?? 19}
                  <span className="text-base text-stone-500"> /mo</span>
                </p>
                <p className="text-sm text-stone-500">
                  per owner · cancel anytime
                </p>
                <ul className="mt-7 space-y-3 text-sm">
            ...
            {/* Premium Plus */}
            <div
              className="rounded-3xl border border-stone-200 bg-foreground text-white p-8 relative overflow-hidden"
              data-testid="pricing-premium-plus"
            >
              <div
                className="absolute inset-0 opacity-50 pointer-events-none"
                style={{
                  background:
                    "radial-gradient(420px 220px at 10% 110%, rgba(196,124,92,0.35), transparent 60%)",
                }}
              />
              <div className="relative">
                <div className="flex items-baseline justify-between">
                  <p className="text-[11px] uppercase tracking-[0.26em] text-primary/70">
                    Premium Plus
                  </p>
                  <span className="rounded-full bg-primary text-white px-3 py-1 text-[10px] uppercase tracking-[0.22em]">
                    Best for chains
                ...
                <p className="font-serif-display text-5xl mt-4">
                  ₹{premiumPlusPlan?.price_monthly ?? 49}
                  <span className="text-base text-stone-300"> /mo</span>
                </p>
                ...
                <Link
                  to="/register"
                  className="mt-8 block"
                  data-testid="pricing-premium-plus-cta"
                >
          ...
          <p className="mt-6 text-[11px] text-stone-500 text-center">
            Go-Next is in preview — paid plans are activated manually by our
            team today. Stripe self-checkout is coming soon.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-5xl px-5 py-20 lg:py-28 text-center">
        ...
        <p className="mx-auto mt-4 max-w-xl text-base sm:text-lg text-stone-600">
          Go-Next is free to start. No card. No contracts. Bring your own
          stations.
        </p>
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          ...
          <Link to="/login" data-testid="final-cta-login">
            <Button
              variant="outline"
              className="rounded-full border-stone-300 h-12 px-8 press"
            >
              I already have one
            </Button>
          </Link>
        ...
        <div className="mt-12 flex flex-wrap items-center justify-center gap-6 text-xs text-stone-500">
          <span className="flex items-center gap-2">
            <CheckCircle2 className="h-3.5 w-3.5 text-success" /> Free tier
            forever
          </span>
          <span className="flex items-center gap-2">
            <CheckCircle2 className="h-3.5 w-3.5 text-success" /> No app to
            install
          </span>
          <span className="flex items-center gap-2">
            <CheckCircle2 className="h-3.5 w-3.5 text-success" /> Works on any
            phone
          </span>
        </div>
      </section>
