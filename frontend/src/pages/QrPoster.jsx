...
export default function QrPoster() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-muted text-stone-500">
        Preparing poster…
      </div>
    );
  }
  ...
  if (error || !business) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-muted px-5 text-center">
        <div className="max-w-md">
          <h1 className="font-serif-display text-3xl text-foreground">Poster unavailable</h1>
  ...
  return (
    <div className="min-h-screen bg-muted" data-testid="qr-poster-page">
      {/* Controls — hidden when printing */}
      <div className="no-print sticky top-0 z-10 border-b border-stone-200 bg-background/95 backdrop-blur">
      ...
      <main className="mx-auto max-w-4xl px-5 py-10 print:p-0 print:max-w-none">
        ...
        >
          <div className="h-full w-full flex flex-col items-center justify-between px-14 py-16 text-foreground">
            ...
            <div className="flex flex-col items-center">
              <div className="rounded-3xl bg-secondary p-8 border border-border">
                <QRCodeSVG
                  value={joinUrl}
                  size={340}
            ...
            <div className="w-full flex items-end justify-between text-xs text-stone-400">
              <div className="flex items-center gap-2">
                <span className="flex h-6 w-6 items-center justify-center rounded-full bg-primary/12 text-primary ring-1 ring-primary/20">
