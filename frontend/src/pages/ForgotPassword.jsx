    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center px-5 py-10">
        <div className="w-full max-w-md">
          <Link
            to="/login"
            className="text-sm text-stone-500 hover:text-stone-800 inline-flex items-center gap-1 mb-5"
          ...
          <p className="mt-3 text-stone-600">
            Enter your account email and we&apos;ll send you a short-lived link
            to set a new one. The link works for <strong>30 minutes</strong>.
          </p>
